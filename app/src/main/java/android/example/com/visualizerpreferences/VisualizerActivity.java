...
public class VisualizerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences thePreferences = PreferenceManager.getDefaultSharedPreferences(this);
        String replyStatus = thePreferences.getString("reply", "");
        Toast.makeText(this, "reply status is: " + replyStatus, Toast.LENGTH_SHORT).show();
    ...
    private void defaultSetup() {
        ...
        mVisualizerView.setMinSizeScale(1.9f);
